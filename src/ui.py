...
def get_service():
    ...
    return OperationsReportingService()
...
if page == "Dashboard (Overview)":
    ...
    st.write(
        f"Summary view of operations metrics for {start_date} to {end_date}"
    )
...
# ===== Page 2: Production Line Quality =====
    ...
    try:
        ...
        if lines_data:
            ...
            for line_code, defect_count in lines_data:
                table_data.append({
                    "Production Line": line_code,
                    "Total Defects": int(defect_count)
                })
...
# ===== Page 3: Defect Trends =====
    ...
    try:
        ...
        if trend_data:
            ...
            ax.plot(df_trend['date'], df_trend['total_defects'], 
                   marker='o', linewidth=2, markersize=8, color='#FF6B6B')
            ax.fill_between(df_trend['date'], df_trend['total_defects'], 
